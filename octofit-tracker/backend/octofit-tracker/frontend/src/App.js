    ...
    <Router>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={
            <div className="card text-center shadow p-4 mt-5">
              <h1 className="display-4 mb-3">Bienvenido a <span className="text-primary">OctoFit Tracker</span></h1>
              <p className="lead">Tu plataforma para registrar actividades, equipos, usuarios, rutinas y competir en el leaderboard.</p>
